...
with open('dataset_203_2.txt') as data:
...
with open('dataset_203_6.txt') as data:
    lines = data.readlines()
    graph = {}
    for line in lines:
        node, vertices = line.strip().split(' -> ')
...
with open('dataset_203_7.txt') as data:
    print(
...
with open('dataset_203_11.txt') as data:
    print(
...
with open('dataset_6206_4.txt') as data:
    lines = data.readlines()
    print(
...
with open('dataset_204_16.txt') as data:
    lines = data.readlines()
    print(
...
with open('dataset_6207_2.txt') as data:
    lines = data.readlines()
    graph = {}
    for line in lines:
        node, vertices = line.strip().split(' -> ')
...
with open('dataset_205_5.txt') as data:
    print(
...
with open('Carsonella_ruddii.txt') as data:
    lines = data.readlines()
    genome = StringReconstructionFromReadPairs(
        [line.strip().split('|') for line in lines],
        k=120,
        d=1000
    )
    contigs = ContigGeneration(sum([line.strip().split('|') for line in lines], []))

with open('Carsonella_ruddii_genome.txt', 'w') as data:
    data.writelines(genome)
    print('Carsonella Ruddii Genome - In file "Carsonella_ruddii_genome.txt"')

with open('Carsonella_ruddii_genome_contigs.txt', 'w') as data:
    data.writelines([contig + '\n' for contig in contigs])
    print('Carsonella Ruddii Genome Contigs - In file "Carsonella_ruddii_genome_contigs.txt"')
